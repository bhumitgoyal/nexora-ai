  ...
  return (
    <Poster page="03 / 08" section="Services">
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                <span className={`grid size-9 place-items-center border border-[var(--color-border-strong)] ${accentBg}`}>
      ...
      <motion.div
        ...
        className="mt-5 border border-dashed border-[var(--color-border-strong)] bg-[var(--color-bg-elev)] px-5 py-4"
      >
      ...
      <motion.div
        ...
        className="mt-3 flex items-center justify-between border border-[var(--color-border-strong)] bg-[var(--color-brand)] px-5 py-4"
      >
