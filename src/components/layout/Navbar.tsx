      ...
      >
        <div className="container-x flex h-16 items-center justify-between md:h-18">
          ...
          <div className="hidden items-center gap-2 md:flex">
            <Link
              href="/booklet"
              className="inline-flex items-center gap-1.5 border border-[var(--color-border)] bg-[var(--color-bg-elev)] px-3.5 py-2 text-xs font-semibold text-[var(--color-fg-muted)] transition-all hover:border-[var(--color-brand)] hover:text-[var(--color-brand)]"
            >
