            ...
            {socials.map((s) => {
              ...
              return (
                <a
                  ...
                  className="flex items-center gap-2 border border-[var(--color-border)] bg-[var(--color-bg-elev)] px-3 py-2 transition-colors hover:border-[var(--color-accent)]/60"
                >
          ...
          <div className="border border-[var(--color-border-strong)] bg-[var(--color-brand)] p-5">
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex flex-col items-end">
                <div className="font-mono text-[10px] uppercase tracking-[0.22em] text-[var(--color-fg-subtle)]">
                  © {new Date().getFullYear()} Nuvero AI · Healthcare Edition
                </div>
